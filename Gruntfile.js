    ...
    grunt.initConfig({
        ...
        less: {
            development: {
                ...
                files: {
                    './public/main.css': ['./app/styles/base.less',  './app/styles/order.less', './app/styles/modal.less', './app/styles/navigation.less', './app/styles/meal.less',  './app/styles/common.less',  './node_modules/toastr/build/toastr.min.css']
                }
            }
        },
        uglify: {
